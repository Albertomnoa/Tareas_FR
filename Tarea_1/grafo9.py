...
A.add_edge('Maria(15)','Fernado(16)' ,weight=2)
A.add_edge('Fernado(16)','Desisy(18)',weight=3)
A.add_edge('Fernado(16)','Desisy(18)',weight=2)
...
A.add_edge('Fernado(16)','Claudia(16)',weight=2)

nodes_reflex = {'Luis(15)','Fernado(16)','Julia(18)'}
nodes_no_reflex = {'Maria(15)','Yanet(17)','Rosi(16)','Desisy(18)',
                   'Pedro(17)','Claudia(16)'}

black=[('Maria(15)','Yanet(17)'),
  ('Maria(15)','Fernado(16)'),('Fernado(16)','Desisy(18)'),
  ('Yanet(17)','Julia(18)'),('Desisy(18)','Pedro(17)'),
  ('Pedro(17)','Julia(18)'),  ('Pedro(17)','Rosi(16)'),
  ('Fernado(16)','Claudia(16)')]

bl=[('Fernado(16)','Desisy(18)'),('Pedro(17)','Rosi(16)')]
