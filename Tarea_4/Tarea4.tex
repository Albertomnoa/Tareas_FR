...
\subfigure[\textit{Erdos renyi graph}, con 20 vértices]{\includegraphics[scale=0.5]{erdosrenyigraph.eps}}
\subfigure[\textit{Fast gnp random graph}, con 15 vértices]{\includegraphics[scale=0.5]{fastgnprandomgraph.eps}}
